...
- (instancetype)initWitDelegate:(id<DataSourceContainerControllerDelegate> _Nullable)delegate sectionKeyPath:(NSString *)sectionKeyPath sectionSortDescriptor:(NSSortDescriptor *)sectionSortDescriptor
{
...
- (void)setObjects:(NSArray *)objects {
    ...
    NSMutableArray *sectionObjects = [NSMutableArray arrayWithObject:sortedObjects[0]];
